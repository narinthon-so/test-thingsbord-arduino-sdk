...
// WiFi access point
#define WIFI_AP_NAME        "Redmi"
// WiFi password
#define WIFI_PASSWORD       "rikuuuuu"

// See https://thingsboard.io/docs/getting-started-guides/helloworld/ 
// to understand how to obtain an access token
#define TOKEN               "y1b5UenmWcqarL7vXnVN"
// ThingsBoard server instance.
#define THINGSBOARD_SERVER  "192.168.218.233"
...
{
  Serial.println("Received the set mode RPC method");
...
{
  Serial.println("Received the get mode RPC method");
