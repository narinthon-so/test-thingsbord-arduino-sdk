...
// WiFi access point
#define WIFI_AP_NAME "BALE"
// WiFi password
#define WIFI_PASSWORD "123456789"

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
#define TOKEN "y1b5UenmWcqarL7vXnVN"
// ThingsBoard server instance.
#define THINGSBOARD_SERVER "192.168.246.233" // IP rpi
...
void loop()
{
  ...
  if (send_passed > send_delay)
  {
    ...
    // tb.sendTelemetryFloat("temperature", random(200, 300) / 10.0);
    // tb.sendTelemetryFloat("ph", random(10, 90) / 10.0);
    Serial.print(tb.sendTelemetryFloat("temperature", random(200, 300) / 10.0));
    Serial.println(tb.sendTelemetryFloat("ph", random(10, 90) / 10.0));

    // Serial.println(tb.sendTelemetryFloat("humi", random(10, 90) / 10.0));
